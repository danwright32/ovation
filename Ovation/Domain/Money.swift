...
struct Money: Equatable, Hashable, Comparable, Codable, Sendable {
    ...
    ///
    /// ONE READER FOR EVERY TYPED AMOUNT (ovation#457). The line's amount field
    /// and the new service type panel's both take one, and a second parser beside
    /// this one is how two fields come to accept different things (L370, L613).
    ///
    ...
    /// nothing indistinguishable from one nobody has priced (L544, L706). What a
